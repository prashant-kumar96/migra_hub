...
interface ProofOfFundsCompProps {
  userId: string;
   onUploadSuccess?: () => void;
}

const ProofOfFundsComp: React.FC<ProofOfFundsCompProps> = ({ userId, onUploadSuccess ,setFiles, files, uploadStatuses, setUploadStatuses }) => {
    ...
    <div className="p-6">
      {isProofOfFundsCompPreviouslyUploaded ? (
        ...
        <UploadModal
          ...
          modalTitle="Upload Proof of Funds Images"
