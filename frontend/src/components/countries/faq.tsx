      ...
      <div className="flex justify-start mb-4">
        {buttons.map((button) => (
          <button
            ...
            className={`inline-flex items-center px-4 py-2 text-md font-medium text-Indigo bg-transparent border border-Indigo ${button.extraClasses} hover:text-FloralWhite hover:bg-Indigo focus:z-10 focus:ring-2 focus:ring-Indigo focus:bg-Indigo focus:text-FloralWhite focus:border-FloralWhite ${
