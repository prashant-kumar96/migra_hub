          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              >
                ...
                /> */}
                <span className="tracking-tight text-FloralWhite text-4xl font-greycliff font-extrabold">MigraHub</span>
              </a>
              <p className="py-2 text-sm text-FloralWhite lg:max-w-xs text-center lg:text-left">
                Trusted in more than 100 countries & 5 million customers. Have
                any query ?
              </p>
              <a
                href="javascript:;"
                className="py-1 px-5 h-9 block w-fit bg-transaprent border-2 border-FloralWhite rounded-full shadow-sm text-[17px] text-FloralWhite mx-auto transition-all  duration-500 hover:bg-FloralWhite  lg:mx-0"
              >
                Contact us
              </a>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
              <h4 className="text-lg text-FloralWhite  tracking-wide  font-medium mb-7">
                Pagedone
              </h4>
              <ul className="text-sm  transition-all duration-500">
                <li className="mb-6">
                  <a
                    href="javascript:;"
                    className="text-FloralWhite hover:underline tracking-wide "
                  >
                    Home
                  </a>
                </li>
            ...
            <div className="lg:mx-auto text-left">
              <h4 className="text-lg text-FloralWhite  tracking-wide  font-medium mb-7">Blogs</h4>
              <ul className="text-sm  transition-all duration-500">
                <li className="mb-6">
                  <a
                    href="javascript:;"
