...
import { getApplicationStatusDetails,sendStatusUpdateEmail,getApplicationDetails,updatePaymentStatus,updateDocumentUploadStatus } from "../controllers/applicationStatusController.js";
