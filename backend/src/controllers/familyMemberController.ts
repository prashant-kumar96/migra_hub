...
export async function getFamilyMemberApplicationDetails(req: any, res: any) {
    try {
        ...
        const applicationStatus = await ApplicationStatus.findOne({applicationId: familyMember.primaryApplicationId});
...
export async function getPrimaryApplicantLinkedFamilyMembers(req: any, res: any) {
    try {
